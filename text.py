...
end_programm = 'Ваша работа закончена! До свидание! )))'

search_index = 'Введите ID для удаления: '

search_ind = 'Введите ID для изменения контакта: '
search_col = 'Введите наименование колонки, которую нужно ввести: '

def change_contact(word: str) -> str:
    return f'Введите новое значение {word}: '
